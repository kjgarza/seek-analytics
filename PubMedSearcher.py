...
class PubmedSearcher:
    ...
    def fetch_all(self, pmid):
        ...
        :return: 
        """
        assert isinstance(pmid, basestring)
    ...
    def get_authors_list(self, pmids):
...
#     handle = efetch(db='pubmed', id=pmid, retmode='text', rettype='abstract', email='garzaguk@.cs.man.ac.uk')
#     print handle.read()
#
#
#
# print_abstract("22686585")


# a = PubmedSearcher("garzaguk@.cs.man.ac.uk")

# print(a.fetch_all("21231375"))

# PMIDs = "21231375,17447753,17447754"

# print(a.get_authors_list(PMIDs))